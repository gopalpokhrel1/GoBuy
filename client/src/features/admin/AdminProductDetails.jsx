...
import { selectSpecificProducts, selectedProductsAsync } from '../product-list/productSlice'
...
export default function AdminProductDetails() {
  ...
  const handleCart = async () => {
    try {
      await dispatch(addToCartAsync({ ...product, quantity: 1, user: user[0].id }));
      await dispatch(fetchedUserByIdAsync(user[0].id));
