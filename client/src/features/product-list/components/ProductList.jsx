...
export default function ProductList() {
  ...
  const handleSort = (e, section) => {
    const val = { ...sort, _sort: section.sort, _order: section.order }
    setSort(val);
                    ...
                    <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-0">
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                        {products.map((product) => (
                          <Link to={`/productDetails/${product.id}`} className='border-2 border-blue-100 p-1 rounded-md'>
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                  <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    >
                      <span className="sr-only" onClick={() => setPage(page - 1)}>Previous</span>
                    ...
                    >
                      <span className="sr-only" onClick={() => setPage(page + 1)}>Next</span>
